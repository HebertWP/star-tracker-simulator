...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_4.setGeometry(QRect(10, 150, 451, 101))
        ...
        self.viewPlot.setGeometry(QRect(0, 250, 701, 461))
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(0, 0, 851, 151))
        ...
        self._automatic_control_frame.setGeometry(QRect(460, 150, 371, 81))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QRect(460, 230, 371, 21))
